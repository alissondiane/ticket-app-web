                        ...
                        <div className="SplitPane row">
                            <div className="col-xs-6" margen_top>
                                <div>
                                    ...
                                    <label>Nombre: {this.props.modalComida}</label>
                            ...
                            <div className="SplitPane row">
                                ...
                                <div className="col-xs-6" margen_top >
                                    ...
                                    <div className="SplitPane row">
                                        ...
                                        <div className="col-xs-6" margen_top>
                                            <button className="waves-effect waves-light btn-large botonazul2 right" onClick={this.props.modalClearOption}>Guardar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
